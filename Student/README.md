...
В основном это связано с кривой забывания. Если Вы что-то прочли неделю назад, а после пытаетесь вспомнить - скорее всего Вы ничего не вспомните. Память не может запомнить сразу большое количество вещей, и фотографической памяти как таковой не существует.
